    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                <a href="/home_admin" class="nav-item nav-link">Beranda</a>
                <a href="/expert" class="nav-item nav-link">Keahlian</a>
                <a href="/mechanic" class="nav-item nav-link">Teknisi</a>
                <a href="/work" class="nav-item nav-link">Pekerjaan</a>
                <a href="/booking_admin" class="nav-item nav-link">Booking</a>
                <a href="/survey" class="nav-item nav-link">Survei</a>
                <a href="/schedule_admin" class="nav-item nav-link">Jadwal</a>
